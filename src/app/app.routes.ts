...
export const routes: Routes = [
    ...
    { path: 'create-event', title: 'New Event | Connect-U', component: CreateEventPageComponent },
    { path: 'my-events', title: 'My Events | Connect-U', component: MyEventsPageComponent },
    { path: 'my-space', title: 'My Space | Connect-U', component: MySpacePageComponent },
